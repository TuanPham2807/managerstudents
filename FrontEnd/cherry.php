...
<body>
    ...
    <div class="container detail__product">
        ...
        <div class="top_left_SP">
            <div class="img_SP">
                <img src="image/Chery.jpg" alt="">
            </div>
            <div class="interaction_SP">
                <h2 style="font-weight: bold; color: rgb(94, 94, 94);">Cherry Mỹ</h2>
                <div>
                ...
                <h2 style="font-weight: bold; color: orange;">319.000<sup>đ</sup>/KG</h2>
                <p>Cherry chứa rất nhiều các chất dinh dưỡng như chất xơ, kali, đồng, magiê cũng như mangan,
                    sắt, canxi, kẽm và phốt pho nên rất tốt cho sức khỏe. Giúp chống oxy hóa, trị tiểu đường, giảm đau khớp,
                    giảm nguy cơ bệnh gút, giảm lượng cholesterol, giảm đau sau khi tập thể dục....</p>
                <div>

                    <div class="purchase__add">
                        <form action="dat-hang.php?MSHH=HH008" method="POST">
                            ...
                            <input name="SoLuongDat" id="result" type="text" max="" min="1" value="1" style="width:50px; margin:0px;">
                    ...
                    <form action="gio-hang.php?MSHH=HH008" method="POST" style="margin-left:300px; margin-top:10px;">
    ...
    <script>
        ...
        function subProduct() {
            if (Number(document.getElementById("result").value) > 1)
                Number(document.getElementById("result").value--)
            else {}
        }
